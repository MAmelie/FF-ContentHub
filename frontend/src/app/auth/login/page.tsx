...
function LoginPageInner() {
  ...
  useEffect(() => {
    ...
    if (jwt) {
      router.push(sanitizeReturnPath(searchParams.get("next")) ?? DEFAULT_POST_LOGIN_PATH);
      return;
    }
  ...
  const handleDiscordLogin = () => {
    ...
    setIsLoading(true);
    setStoredPostLoginReturn(searchParams.get("next"));
    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h1 className="mb-2 text-2xl font-bold text-gray-900 font-didot">FF Member Portal</h1>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-md w-full space-y-8 text-center">
        <h2 className="text-3xl font-extrabold text-gray-900 font-didot">Sign in</h2>
        <p className="text-sm text-gray-600 font-plex">Loading...</p>
      </div>
    </div>
  );
}
