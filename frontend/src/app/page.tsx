...
function HomeContent() {
  ...
  const renderTileCard = (tile: Tile, idx: number, fallbackBg: string) => (
    ...
    >
      ...
      <div className="p-4 sm:p-5 md:p-6 h-3/5 flex flex-col">
        ...
        <div className="mt-auto pt-3 flex justify-end">
          <span className="text-brand-orange transition-transform duration-300 group-hover:translate-x-0.5" aria-hidden="true">
